...
namespace Bookstore.Services.ShoppingBasket.Migrations
{
    ...
    [Migration("20210803161009_ShopingBasketBooks")]
    partial class ShopingBasketBooks
    {
            ...
            modelBuilder.Entity("Bookstore.Services.ShoppingBasket.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2021, 9, 3, 18, 10, 9, 586, DateTimeKind.Local).AddTicks(8333),
                            Title = "The Shining"
                        },
                        new
                        {
                            BookId = new Guid("a3749477-f823-4124-aa4a-fc9ad5e79cd6"),
                            Date = new DateTime(2021, 10, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9641),
                            Title = "Misery"
                        },
                        new
                        {
                            BookId = new Guid("70a1f9b9-0a37-4c1a-99b1-c7709fc64167"),
                            Date = new DateTime(2021, 11, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9670),
                            Title = "It"
                        },
                        new
                        {
                            BookId = new Guid("60188a2b-2784-4fc4-8df8-8919ff838b0b"),
                            Date = new DateTime(2021, 12, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9709),
                            Title = "The Stand"
                        },
                        new
                        {
                            BookId = new Guid("447eb762-95e9-4c31-95e1-b20053fbe215"),
                            Date = new DateTime(2022, 1, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9713),
                            Title = "A Game of Thrones"
                        },
                        new
                        {
                            BookId = new Guid("bc4c35c3-3857-4250-9449-155fcf5109ec"),
                            Date = new DateTime(2022, 2, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9717),
                            Title = "The Winds of Winter"
                        },
                        new
                        {
                            BookId = new Guid("09af5a52-9421-44e8-a2bb-a6b9ccbc8239"),
                            Date = new DateTime(2022, 3, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9721),
                            Title = "A Dance with Dragons"
                        },
                        new
                        {
                            BookId = new Guid("9edf91ee-ab77-4521-a402-5f188bc0c577"),
                            Date = new DateTime(2022, 4, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9725),
                            Title = "American Gods"
                        },
                        new
                        {
                            BookId = new Guid("01457142-358f-495f-aafa-fb23de3d67e9"),
                            Date = new DateTime(2022, 5, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9728),
                            Title = "Speechless"
                        },
                        new
                        {
                            BookId = new Guid("e57b605f-8b3c-4089-b672-6ce9e6d6c23f"),
                            Date = new DateTime(2022, 6, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9732),
                            Title = "The Hitchhiker's Guide to the Galaxy"
                        },
                        new
                        {
                            BookId = new Guid("1325360c-8253-473a-a20f-55c269c20407"),
                            Date = new DateTime(2022, 7, 3, 18, 10, 9, 587, DateTimeKind.Local).AddTicks(9736),
                            Title = "Easy Money"
                        });
                });
